...
function setupCounterHoverAnimation() {
    ...
    aboutSection.addEventListener('mouseenter', function() {
        ...
        aboutSection.style.boxShadow = '0 0 0 3px rgba(16, 185, 129, 0.5)';
        setTimeout(() => {
            aboutSection.style.boxShadow = '';
        }, 1000);
    });
    
    // Также можно добавить анимацию при клике (на мобильных устройствах)
...
function handleFormSubmit(event) {
    ...
    setTimeout(() => {
        formMessage.textContent = 'Спасибо! Ваша заявка отправлена. Я свяжусь с вами в ближайшее время.';
